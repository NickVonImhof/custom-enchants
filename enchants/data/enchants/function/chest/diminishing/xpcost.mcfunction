...
execute store result score @s lvl run data get entity @s Inventory[{Slot:102b}].components.minecraft:enchantments.levels.enchants:diminishing

#multiplier per lvl
scoreboard players set @s delta 4
scoreboard players operation @s lvl *= @s delta
#base value
scoreboard players set @s delta 12
scoreboard players operation @s lvl += @s delta
